...
#include "../../LessonSelect/reservation.h"
...
void reservation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (reservation::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&reservation::displayr)) {
                *result = 0;
                return;
            }
        }
