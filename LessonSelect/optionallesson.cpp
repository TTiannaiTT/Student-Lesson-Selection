...
#include "ui_optionallesson.h"
#include"slesson.h"

optionalLesson::optionalLesson(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::optionalLesson)
{
    ui->setupUi(this);
...
optionalLesson::~optionalLesson()
{
    delete ui;
}

void optionalLesson::on_pushButton_3_clicked()
{
    QVector<slesson> alllessonInfo;
    QFile file("optionalLesson.txt");
    file.open(QIODevice::ReadOnly|QIODevice::Text);
...
void optionalLesson::on_pushButton_4_clicked()
{
    QVector<slesson> alllessonInfo;
    QFile file("optionalLesson.txt");
    file.open(QIODevice::ReadOnly|QIODevice::Text);
